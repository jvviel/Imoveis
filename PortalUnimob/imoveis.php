      ...
      <div class="container">
            ...
            <div class="col-md-12">
             <font color="#1e88e5" size="5"> Imóvel Selecionado </font>
                <div class="row carousel-holder">
                    <div class="col-md-15" style="width: 100%; height: 100%;">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="#"><img class="slide-image" src="img/interior1.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img class="slide-image" src="img//interior2.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img class="slide-image" src="img//interior3.jpg" alt=""></a>
                                </div>
                            </div>
        ...
        <div class="col-lg-6 col-sm-6 portfolio-item">
            ...
            <font color="#1e88e5">
              ...
              <b>
              <font size="3" >
              <p class="card-text">Endereço: Dr. Gurgel, 226 Apto 709</p>
              <p class="card-text">Bairro: Centro</p>
              <p class="card-text">Cidade: Presidente Prudente</p>
              <p class="card-text">Quartos: 3</p>
              <p class="card-text">Garagem para 1 carro</p>
              <p class="card-text">Contato: (18) 3333-3333</p>
              </font>
              </b>
            </div>
        </div>
