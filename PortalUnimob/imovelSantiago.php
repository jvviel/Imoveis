      ...
      <div class="container">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="#"><img class="slide-image" src="img/interior4.jpg" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img class="slide-image" src="img//interior5.png" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img class="slide-image" src="img//interior6.png" alt=""></a>
                                </div>
                            </div>
        ...
        <div class="col-lg-6 col-sm-6 portfolio-item">
            ...
            <font color="#1e88e5">
              ...
              <b>
              <font size="3" >
              <p class="card-text">Endereço: Av. Rui Barboda, 520 Apto 120</p>
              <p class="card-text">Bairro: Vila Ouro</p>
              <p class="card-text">Cidade: Presidente Prudente</p>
              <p class="card-text">Quartos: 2</p>
              <p class="card-text">Garagem para 1 carro</p>
              <p class="card-text">Contato: (18) 5555-5555</p>
              </font>
              </b>
            </div>
        </div>
